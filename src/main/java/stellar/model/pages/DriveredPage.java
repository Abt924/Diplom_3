...
public class DriveredPage {
    ...
    public void waitForClickableElement(By selector) {
        new WebDriverWait(driver, 5).until(ExpectedConditions.elementToBeClickable(selector));
    }
    ...
    public void waitForElementAttributeNotContains(By selector, String attr, String substring) {
        new WebDriverWait(driver, 30).until(not(ExpectedConditions.attributeContains(selector, attr, substring)));
    }
}
